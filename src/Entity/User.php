...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addSelling(Product $selling): self
    {
    ...
    public function removeSelling(Product $selling): self
    {
    ...
    public function addOrdering(Order $ordering): self
    {
        if (!$this->ordering->contains($ordering)) {
            $this->ordering->add($ordering);
            $ordering->setBuyer($this);
        }

        return $this;
    }

    public function removeOrdering(Order $ordering): self
    {
        if ($this->ordering->removeElement($ordering)) {
            // set the owning side to null (unless already changed)
            if ($ordering->getBuyer() === $this) {
                $ordering->setBuyer(null);
            }
        }
